...
/**
 *  A Board object represents a grid containing rows
...
public class Board extends JPanel {
	...
	private int rows = 42;       // The number of rows of rectangles in the grid.
	private int columns = 42;    // The number of columns of rectangles in the grid.
	private Color defaultColor;   // Color used for any rectangle whose color
								//    has not been set explicitly.  This
								//    can never be null.
	private Color groutingColor=Color.black;  // The color for "grouting" between 
	...
	private boolean needsRedraw;   // This is set to true when a change has occurred that
							private int preferredBlockWidth;
							private int preferredBlockHeight;
	...
	/**
	 *  Construct a Board with the specified number of rows and
	 ...
	 */
	public Board(int rows, int columns, int preferredBlockWidth, int preferredBlockHeight, Color borderColor, int borderWidth) {
		this.rows = rows;
		this.columns = columns;
		grid = new Color[rows][columns];
		this.preferredBlockWidth = preferredBlockWidth;
		...
		if (borderColor != null) {
			...
			borderWidth = 0;
		//sets size of panel which includes Board and border size
	...
	/**
	 * Given an x-coordinate of a pixel in the Board, this method returns
	...
	/**
	 * Given a y-coordinate of a pixel in the Board, this method returns
